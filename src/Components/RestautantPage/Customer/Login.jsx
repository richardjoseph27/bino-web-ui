                    ...
                    <Div className='col text-left'>
                        ...
                        <div className='container mt-2'>
                                ...
                                <div className='ml-3 col'>
                                    ...
                                    <div className='row'>
                                        ...
                                        <div className='col align-self-start text-left'>
                                            <SignUp toggleDrawerP={toggleDrawer}/>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className='container-fluid mt-3'>
                                <div className='row'>
                                <CustomInputField label='Phone Number' onChange={(id, value) => setPhoneNumber(value)}/>
    ...
    return (
        <div>
            ...
            focus= {{
                ...
                type='button'
                className='nav-link btn btn-lg align-self-center outline-none'
